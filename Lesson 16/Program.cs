...
Console.WriteLine();
Console.WriteLine("Метод получает на вход 3 числа (A, B и С). Дано линейное уравнение стандартного вида: 'A*X + B = C'. Найдём 'X':");
Console.WriteLine();
...
Console.WriteLine();
double x = Calculator.FindX(a, b, c);
Calculator.WriteResult(x);
Console.WriteLine();
...
Console.WriteLine();
Console.WriteLine("Метод получает на вход 2 числа (A и B). Если A больше B, подсчитать A+B, если A равно B, подсчитать A*B, если A меньше B, подсчитать A-B.");
Console.WriteLine();
...
Calculator.WriteResultOfCompare(result);
Console.WriteLine();
...
Console.WriteLine();
Console.WriteLine("Метод получает на вход двузначное число. Верните прописную запись этого числа.");
Console.WriteLine();
...
Console.WriteLine();
Console.WriteLine("Метод получает на вход число. Проверить попадает ли оно в один из диапазонов: от 0 до 10, от 20 до 30 или от 40 до 50.");
Console.WriteLine();
...
Console.WriteLine();
Console.WriteLine();
Console.WriteLine("Метод получает на вход 2 числа (A и B). Верните сумму всех чисел из диапазона от A до B, которые делятся на 7.");
Console.WriteLine();
...
Console.WriteLine();
Console.WriteLine("Метод получает на вход положительное число (N). Верните N-ое число ряда Фибоначчи.");
Console.WriteLine();
...
Console.WriteLine();
Console.WriteLine("Метод получает на вход число. Найти количество нечетных цифр этого числа.");
Console.WriteLine();
Console.Write("Введите целое положительное число: ");
...
Console.WriteLine();
Console.WriteLine("Метод получает на вход число. Найти число, которое является зеркальным.");
Console.WriteLine();
Console.Write("Введите целое положительное число: ");
...
Console.WriteLine();
Console.WriteLine("Метод получает на вход 2 числа. Сообщите, есть ли в написании двух чисел одинаковые цифры?");
Console.WriteLine();
Console.Write("Введите первое целое число: ");
