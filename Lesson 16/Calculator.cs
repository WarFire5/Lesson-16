namespace Lesson_16
{
    public static class Calculator
    {
        ...
        public static void WriteResult(double x)
        {
            Console.WriteLine();
        ...
        public static void WriteResultOfCompare(double result)
        {
        ...
        public static int CheckAndWriteNumber(int n)
        {
            ...
            {
                Console.WriteLine("'Введите двузначное число, которое больше нуля'.");
                Console.WriteLine();
            }
            return nCheck;
        }
